...
# url = "http://172.16.15.77:2222/api/vlm/v1/aimemo_update/"
# url = "http://172.16.15.83:2222/api/vlm/v1/aimemo_update/"
# url = "http://localhost:2222/api/vlm/v1/aimemo_update/"
# url = "http://0.0.0.0:2222/api/vlm/v1/aimemo_update/"
url = "http://127.0.0.1:2222/api/vlm/v1/aimemo_update/"
i = 0
while 1:
    ...
    # Text description
    aiout0 = {"aimemo": f"{text}0. 어린이들이 기차놀이 하고 있습니다. 옆에는 우거진 나무들이 있고, 많은 사람들이 보고 있습니다.이 사진에는 나무가 우거진 야외 공간에서 여러 명의 아이들이 함께 춤을 추고 있는 장면이 담겨 있습니다. 아이들은 모두 캐주얼한 청바지와 흰색 상의를 입고 있으며, 서로 팔을 벌려 손을 맞잡은 상태로 원형을 그리며 춤을 추는 모습입니다. 사진의 배경에는 많은 사람들이 앉아 있거나 서서 이 장면을 관람하고 있는 모습이 보입니다. 나무가 무성하게 자란 배경과 아이들의 활동적인 춤 동작이 조화를 이루며, 자연 속에서 열린 즐거운 행사임을 보여줍니다. 관람객들은 대부분 편안한 옷차림을 하고 있으며, 웃으며 춤을 지켜보고 있는 듯합니다.", "score": 0.91,"event": "기차놀이","camera_uid":"카메라 방배1"}
    aiout1 = {"aimemo": f"{text}1. 이 사진은 도시의 횡단보도를 건너고 있는 한 여성을 중심으로 촬영된 장면입니다. 여성은 밝은 하늘색 상의와 청바지를 입고 있으며, 어깨에는 가죽 가방을 메고 있습니다. 그녀는 여유로운 걸음으로 횡단보도를 건너고 있으며, 도로에는 여러 대의 차량이 대기하고 있는 모습이 보입니다.\
    ...
    aiout2 = {"aimemo": f"{text}2. 이 사진은 밝고 맑은 날씨 아래에 있는 대형 광장의 모습을 담고 있습니다. 사진 속 광장은 사람들이 많이 모여 있는 활기찬 분위기로, 여러 명의 사람들이 광장의 벤치에 앉아 휴식을 취하거나 대화를 나누고 있습니다. \
    ...
    aiout3 = {"aimemo": f"{text}3. 하얀 건물과 나무.", "score": 0.91,"event": "하얀 건물과 나무","camera_uid":"카메라 방배1"}
    aiout4 = {"aimemo": f"{text}4. 군인이 백파이프 불고 있음.", "score": 0.99,"event": "군인이 백파이프 불고 있음","camera_uid":"카메라 방배1"}
    aiout5 = {"aimemo": f"{text}5. 파라솔 아래에 앉아 있는 커플.", "score": 0.99,"event": "파라솔 아래에 앉아 있는 커플, 노랑 아파트 옆에서","camera_uid":"카메라 방배1"}    
    aiout6 = {"aimemo": f"{text}6. 어린이들이 줄 아래를 지남.", "score": 0.95,"event": "어린이들이 줄 아래를 지남","camera_uid":"카메라 방배1"}
    aiout7 = {"aimemo": f"{text}7. 빨간 옷 입은 여성.", "score": 0.91,"event": "빨간 옷 입은 여성","camera_uid":"카메라 방배1"}
    aiout8 = {"aimemo": f"{text}8. 많은 사람들이 노인들 무도회 인듯.", "score": 0.99,"event": "많은 사람들이 노인들 무도회 인듯","camera_uid":"카메라 방배1"}
    aiout9 = {"aimemo": f"{text}9. 분홍색 어린이 들이 발레이.", "score": 0.95,"event": "분홍색 어린이 들이 발레이","camera_uid":"카메라 방배1"}
    aiout10 = {"aimemo": f"{text}10. 페레이드.", "score": 0.91,"event": "페레이드","camera_uid":"카메라 방배1"}
    aiout11 = {"aimemo": f"{text}11. 빨간 어린이들 광장.", "score": 0.99,"event": "빨간 어린이들 광장","camera_uid":"카메라 방배1"}
    aiout12 = {"aimemo": "restart", "score": 0,"event": "restart","camera_uid":"restart"}

    # aiout12 = {"aimemo": "11. .", "score": 0.95,"event": "Hounoring the spirit of children 시위 행진"}
    ...
    response = requests.post(url, files=image_file, data=aiout)
    # Output the response
    print('-------------------------------',url)
    print(response.json())
    i += 1
